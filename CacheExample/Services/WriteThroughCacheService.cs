...
{
    public class WriteThroughCacheService<TModel> : MultiLayerCacheService<TModel> where TModel : ModelWithId<string>, new()
    {
        public WriteThroughCacheService(IMemoryCache memoryCache, IConfigurationRoot configuration) : base(memoryCache, configuration)
        {
        }
